...
CYAN='\033[0;36m'
echo -e "${CYAN}|-------------|---------------|----------------|----------------|${NC}"
echo -e "${CYAN}|EDIT     __  |BY  _______    | ___ mr_jwker___ |  ____________  |${NC}"
...
echo -e "${CYAN}|-------------|---------------|----------------|----------------|${NC}"
echo -e "${CYAN}|-------------|---------------|----------------|----------------|${NC}"
echo -e "${CYAN}jwker GOD INSTALLED! Create a bot with launch(./launch.sh)${NC}"
echo -e "${CYAN}Edit and put your sudo id in(nano bot.lua)${NC}"
echo -e "${CYAN}Then use anticrash for lifetime runing bot(screen ./jwker)${NC}"
exit
